...
- alternatives: un array di massimo 2 oggetti reali rappresentanti i calciatori alternativi nello stesso ruolo in quella specifica Nazionale che potrebbero insidiare la titolarità, con le chiavi: name (nome dell'alternativa), playProbability (probabilità percentuale, es: "35%") e comment (breve commento di 1-2 frasi su chi sia questo giocatore e come contende il posto al titolare).
